...
class HFCPOLoss(HFAlignmentLoss):
    ...
    """
    def __init__(self, alpha: float = 1.0, beta: float = 0.1, ignore_index: int = -100, label_smoothing: float = 0.0):
        super(HFCPOLoss).__init__(alpha=alpha, beta=beta, ignore_index=ignore_index)
